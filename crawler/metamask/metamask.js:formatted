        ...
        class o extends n.Duplex {
            ...
            _onData(e) {
                if (this._init)
                    ...
                    this._write("ACK", null, i)) : "ACK" === e && (this._init = !0,
    ...
    14: [function(e, t, r) {
        (function(r, n) {
            ...
            w.prototype.read = function(e) {
                ...
                t.sync = !1,
                t.reading || (e = S(r, t))),
                null === (n = e > 0 ? P(e, t) : null) ? (t.needReadable = !0,
                e = 0) : t.length -= e,
            ...
            w.prototype.pipe = function(e, t) {
                ...
                function g(t) {
                    h("ondata"),
                    p = !1,
                    !1 !== e.write(t) || p || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== A(o.pipes, e)) && !f && (h("false write response, pause", n._readableState.awaitDrain),
    ...
    23: [function(e, t, r) {
        ...
        class p extends u.default {
            constructor(e, {jsonRpcStreamName: t="metamask-provider", logger: r=console, maxEventListeners: n=100}={}) {
                if (super(),
                !d.duplex(e))
                    throw new Error(f.default.errors.invalidDuplexStream());
                this._log = r,
            ...
            _handleDisconnect(e, t) {
                if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !e) {
                    ...
                    e ? (r = new c.EthereumRpcError(1013,t || f.default.errors.disconnected()),
                    this._log.debug(r)) : (r = new c.EthereumRpcError(1011,t || f.default.errors.permanentlyDisconnected()),
                    this._log.error(r),
                    this.chainId = null,
 ...
 */
        ...
        function a(e, t, r) {
            ...
            var i = function(e) {
                ...
                if (void 0 !== e.length)
                    return "number" != typeof e.length || U(e.length) ? o(0) : c(e);
        ...
        s.compare = function(e, t) {
            if (D(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)),
        ...
        s.prototype.compare = function(e, t, r, n, i) {
            ...
            if (this === e)
                return 0;
            for (var o = (i >>>= 0) - (n >>>= 0), a = (r >>>= 0) - (t >>>= 0), u = Math.min(o, a), l = this.slice(n, i), c = e.slice(t, r), d = 0; d < u; ++d)
                if (l[d] !== c[d]) {
                    o = l[d],
                    a = c[d];
                    break
                ...
                if ("object" == typeof t && null !== t) {
                    for (u = 0; u < o.length; u++)
                        if (o[u] === t) {
                            ...
                            return void (void 0 !== l.get ? l.configurable ? (Object.defineProperty(a, r, {
                                value: "[Circular]"
                            }),
                            n.push([a, r, t, l])) : i.push([t, r]) : (a[r] = "[Circular]",
                            n.push([a, r, t])))
                        }
    ...
    59: [function(e, t, r) {
        !function(e, r) {
            ...
            u.getLogger = function(e) {
                ...
                var t = l[e];
                return t || (t = l[e] = new a(e,u.getLevel(),u.methodFactory)),
                t
            }
            ;
            var c = "undefined" != typeof window ? window.log : void 0;
            return u.noConflict = function() {
                return "undefined" != typeof window && window.log === u && (window.log = c),
                u
            }
            ,
